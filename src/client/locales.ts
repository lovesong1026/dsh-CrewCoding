...
export const CREW_LOCALE_NAMESPACE = 'crew'
...
/** Crew namespace key union. */
export type CrewLocaleKey = keyof typeof zh
...
} satisfies Record<CrewLocaleKey, string>

/** Translation function consumed by pure view helpers. */
export type CrewTranslate = (
  key: CrewLocaleKey,
