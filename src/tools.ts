 ...
 */
export function registerCrewTools(ctx: Context, config: ToolsConfig): CrewRuntime {
  ...
  const updateStagedPlanBatch: CrewRuntime['updateStagedPlanBatch'] = async (captain, teamId, mutations, signal) => {
  ...
  const updateStagedPlan: CrewRuntime['updateStagedPlan'] = async (captain, teamId, mutation, signal) => (
    updateStagedPlanBatch(captain, teamId, [mutation], signal)
  )

  const approveStagedTeam: CrewRuntime['approveStagedTeam'] = async (captain, teamId, signal) => {
    const workspace = workspaceOf(captain)
    const stateRoot = stateRootOf(workspace, config)
  ...
  const continueStagedPlanning: CrewRuntime['continueStagedPlanning'] = async (captain, teamId) => {
    const workspace = workspaceOf(captain)
    const stateRoot = stateRootOf(workspace, config)
  ...
  const discardStagedTeam: CrewRuntime['discardStagedTeam'] = async (captain, teamId) => {
    const workspace = workspaceOf(captain)
    const stateRoot = stateRootOf(workspace, config)
