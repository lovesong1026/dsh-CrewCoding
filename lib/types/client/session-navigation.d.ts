...
export interface CrewSessionNavigator {
 ...
 */
export declare function openAgentTeamMember(sessions: CrewSessionNavigator, parentSessionId: SessionId, childSessionId: SessionId): Promise<'subagent' | 'session'>;
