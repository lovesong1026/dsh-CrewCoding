...
export declare const ACTIVITY_STATE_URL = "/plugins/dsh-crew/state";
export declare const ACTIVITY_HALT_URL = "/plugins/dsh-crew/halt";
...
export interface ActivityPollingRuntime {
     ...
     * Crew card capable of registering an explicit monitor target.
     */
