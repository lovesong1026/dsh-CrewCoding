 ...
 */
import { type AcceptanceResult, type CommandResult, type FindingSeverity, type ReviewFinding, type ReviewPolicy, type ReviewVerdict, type TaskKind, type TaskStatus, type TeamState, type TeamTask, type TaskAccess } from './types.ts';
...
export declare function taskAccessOf(task: Pick<TeamTask, 'kind' | 'access'> | undefined): TaskAccess;
