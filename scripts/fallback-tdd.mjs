...
const assignment = assignmentPrompt({ taskId: 't1', memberName: 'worker', memberId: 'm', attempt: 1, attemptId: 'a', subject: 'Work', dependencyOutputs: [], executionPrompt: prompt }, '.crew', 'demo')
const persona = memberPersona({ name: 'Demo', id: 'demo', description: 'goal', captainSessionId: 'c', createdAt: 0, profile: { name: 'demo' }, members: [], tasks: [], taskSeq: 0 }, { name: 'worker', id: 'm', executionPrompt: prompt, joinedAt: 0, status: 'idle' }, '.crew')
